...
// import { useLanguage } from '@/contexts/LanguageContext'; // Will get translations via props
import Image from 'next/image';
import Link from 'next/link';
import { useEffect, useState } from 'react'; // Re-enabling useState for the test
